    ...
    return (
        <main className="bg-navy min-h-screen pt-32 pb-24 relative overflow-hidden">
            ...
            <div className="container-custom relative z-10 text-center mb-16">
                <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-5 py-2 text-white/80 text-sm font-bold mb-6">
                    <Calculator className="w-4 h-4 text-primary" /> Instant Pricing Engine
                </div>
                <h1 className="font-display font-extrabold text-5xl md:text-7xl text-white mb-6 tracking-tight">
            ...
            <div className="container-custom px-4 relative z-10">
                ...
                <div className="mt-24 max-w-4xl mx-auto grid md:grid-cols-2 gap-8 text-left">
                    <div className="bg-white/5 border border-white/5 rounded-3xl p-8 backdrop-blur-md">
                        <h3 className="text-xl font-bold text-white mb-3">Is this a final quote?</h3>
