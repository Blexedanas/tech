...
export const servicesData: Record<string, ServiceData> = {
    ...
    'php': { slug: 'php', badge: 'Development', title: 'Modern Backend', subtitle: 'PHP Development', color: '#00D1FF', iconName: 'brain', description: 'Highly scalable and secure backend PHP solutions for SaaS products and custom web apps.', features: ['Custom MVC Architecture', 'RESTful API Dev', 'Database Design', 'Payment Integrations', 'Legacy Code Upgrades', 'Third-party Syncs'], benefits: [{ title: 'High Performance', desc: 'Modern PHP frameworks provide incredibly fast execution for complex logic.' }, { title: 'Server Efficiency', desc: 'Uses minimal server resources while handling millions of logic requests.' }, { title: 'Vast Ecosystem', desc: 'Countless libraries and integrations make extending your app faster.' }], tech: ['Laravel', 'Symfony', 'CodeIgniter', 'PHP 8+'], process: commonProcess },
    'cms': { slug: 'cms', badge: 'Development', title: 'Your Content', subtitle: 'Custom CMS', color: '#00D1FF', iconName: 'layers', description: 'Bespoke Content Management Systems tailored to your exact workflow and data structure.', features: ['Headless CMS Setup', 'Custom Dashboards', 'Role-based Access', 'Multi-language Support', 'API Delivery', 'Media Management'], benefits: [{ title: 'Easy Management', desc: 'Update everything in clicks without writing a single line of code.' }, { title: 'Omnichannel', desc: 'Publish once in the headless CMS and automatically push to Web, App, and IoT.' }, { title: 'Workflow Ready', desc: 'Draft, review, and publish states built exactly for your editorial team.' }], tech: ['Sanity', 'Strapi', 'Contentful', 'GraphQL'], process: commonProcess },
    'magento': { slug: 'magento', badge: 'Development', title: 'Enterprise Store', subtitle: 'Magento Expert', color: '#00D1FF', iconName: 'cpu', description: 'Robust, flexible, and scalable eCommerce solutions for high-volume enterprise stores.', features: ['B2B & B2C Solutions', 'Multi-Store Setup', 'ERP/CRM Integration', 'Custom Module Dev', 'Performance Tuning', 'Headless Magento'], benefits: [{ title: 'Enterprise Power', desc: 'Manage millions of SKUs and extreme traffic volumes effortlessly.' }, { title: 'Total Flexibility', desc: 'Completely open-source, meaning any feature you can imagine can be built.' }, { title: 'Global Selling', desc: 'Manage multiple regional stores, currencies, and languages from one dashboard.' }], tech: ['Magento 2', 'Adobe Commerce', 'PHP', 'ElasticSearch'], process: commonProcess },
